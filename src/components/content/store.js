...
const dimMap = {
  0: [34, 31, 0, -11, 0, 2, 1.2, 2.3],
  1: [7, 29, 0, -11, 1, 3, 1.3, 2.4],
  2: [23, 28, 0, -11, 0, 1, 1.3, 2.5],
  3: [25, 31, 0, -11, 0, 2, 1.3, 2.3],
  4: [30, 35, 0, -11, 0, 1, 1.2, 2],
  5: [31, 28, 0, -11, 1, 1, 1.2, 2.5],
  6: [24, 28, 0, -11, 0, 0, 1.2, 2.5],
  7: [27, 35, 0, -11, 0, 2, 1.2, 2],
  8: [27, 33, 0, -11, 0, 1, 1.3, 2.1],
  9: [28, 40, 0, -9, 0, 1, 1.2, 1.8],
  '!': [11, 65, 0, -10, 5, 10, 1, 1],
  ...
  A: [75, 70, 0, -10, 0, 0, 0.9, 1],
  B: [49, 70, 0, -10, 0, 0, 0.9, 1],
  C: [53, 70, 0, -10, 0, 0, 0.9, 1],
  D: [56, 70, 0, -10, 0, 0, 0.9, 1],
  E: [54, 70, 0, -10, 0, 1, 0.9, 1],
  F: [45, 70, 0, -10, 0, 1, 0.9, 1],
  G: [50, 70, 0, -10, 0, 1, 0.9, 1],
  H: [54, 70, 0, -10, 0, 0, 0.9, 1],
  I: [46, 70, 0, -10, 1, 1, 0.9, 1],
  J: [52, 70, 0, -10, 0, 1, 0.9, 1],
  K: [46, 70, 0, -10, 0, 0, 0.9, 1],
  L: [49, 70, 0, -10, 0, 0, 0.9, 1],
  M: [82, 70, 0, -10, 0, 1, 0.9, 1],
  N: [67, 70, 0, -10, 0, 2, 0.9, 1],
  O: [51, 70, 0, -10, 0, 1, 0.9, 1],
  P: [51, 70, 0, -10, 0, 1, 0.9, 1],
  Q: [66, 70, 0, -10, 0, 1, 0.9, 1],
  R: [44, 70, 0, -10, 0, 1, 0.9, 1],
  S: [40, 70, 0, -10, 0, 1, 0.9, 1],
  T: [72, 70, 0, -10, 0, 1, 0.9, 1],
  U: [54, 70, 0, -10, 0, 1, 0.9, 1],
  V: [62, 70, 0, -10, 0, 1, 0.9, 1],
  W: [75, 70, 0, -10, 0, 1, 0.9, 1],
  X: [51, 70, 0, -10, 0, 1, 0.9, 1],
  Y: [52, 70, 0, -10, 0, 1, 0.9, 1],
  Z: [66, 70, 0, -10, 0, 1, 0.9, 1],
